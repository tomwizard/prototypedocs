...
**Figure 3.1. Example Endpoint Agent Labels on the** [**Endpoint Agent &gt; Agent Settings &gt; Agent Labels tab**](https://app.thousandeyes.com/endpoint/agent-settings/?section=labels)
